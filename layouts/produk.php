...
<head>
      ...
      <title>Tokoyaki Store</title>

      <link rel="shortcut icon" href="layouts/assets/img/valcon.png" type="image/x-icon">
...
<body>
      ...
      <aside>
            ...
            <header>
                  <img src="<?=AST ?>/img/Lo.jpg" class="brand">
                  <div class="user">Dara Amelia</div>
            </header>
      ...
      <main>
            ...
            <footer>
                  Copyright &copy; 2023. Designed by Dara Amelia
            </footer>
      </main>
